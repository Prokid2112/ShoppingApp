...
module.exports = {
	async apply(value, previousValues) {
		return new Promise(resolve => {
			console.log('\n');
			console.log(
				'TheCodingMachine React-Native ShoppingApp initialized with success ! 🚀\n'
			);
			console.log(
				`${green(
					'                                                                    .-`    `::  \n' +
			...
			console.log(
				'- 📚 If you need to read more about this shoppingapp : https://thecodingmachine.github.io/react-native-shoppingapp/'
			);
			console.log(
				'- 🤕 If you have some troubles : https://github.com/thecodingmachine/react-native-shoppingapp/issues'
			);
			console.log(
				'- ⭐ If you love this shoppingapp, give us a star, you will be a ray of sunshine in our lives :) https://github.com/thecodingmachine/react-native-shoppingapp'
			);
